...
df = pd.read_csv(r'/home/jam/prd_arma_ma/arma_prd/output/results/2023-03-24.csv')[['product_name','positionType','forecastDay','maDiff','forecastDiff','percDiff','retScore','pointForecast']]
