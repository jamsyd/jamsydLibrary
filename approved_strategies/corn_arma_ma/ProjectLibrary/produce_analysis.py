...
metadata    = pd.read_csv(r'C:\Users\James Stanley\Documents\GitHub\backtest_utilities\approved_strategies\corn_arma_ma\output\arma_(3,3)\metadata_corn_(3, 3)_True_5.csv',parse_dates=True,index_col='asofdate')
